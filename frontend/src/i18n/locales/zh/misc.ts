export default {
  ...
  version: {
    ...
    authorVersion: '作者版本',
    customTarget: '私有镜像目标',
    customUpdateReady: '私有版本已构建完成',
    customBuildPending: '私有镜像正在构建',
    customBuildPendingHint: '同步与构建完成后即可在这里更新，请稍后刷新',
    updateCustomNow: '更新私有镜像',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
    ...
    restartNow: '立即重启',
    restarting: '正在重启...',
    containerRestarting: '正在替换并重启容器',
    containerRestartHint: '连接会短暂中断，恢复后页面将自动刷新',
    containerRestartTimeout: '未检测到新容器，请检查 Watchtower 日志后重试',
    containerTargetMissing: '服务器未返回私有镜像目标版本',
    retry: '重试',
    rollback: '版本回退',
