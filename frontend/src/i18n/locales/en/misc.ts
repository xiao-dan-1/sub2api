export default {
  ...
  version: {
    ...
    customTarget: 'Custom image target',
    customUpdateReady: 'Custom package is ready',
    customBuildPending: 'Custom image is still building',
    customBuildPendingHint: 'Refresh shortly after synchronization and packaging finish.',
    updateCustomNow: 'Update custom image',
    ...
    containerRestarting: 'Replacing and restarting the container',
    containerRestartHint: 'The connection may drop briefly. This page reloads when it returns.',
    containerRestartTimeout: 'The new container was not detected. Check Watchtower logs and retry.',
    containerTargetMissing: 'The server did not return a custom target version.',
    retry: 'Retry',
