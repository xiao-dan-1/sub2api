...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	containerTagClient := repository.ProvideContainerTagClient(configConfig)
	containerUpdater := repository.ProvideContainerUpdater(configConfig)
	customImageUpdateService := service.ProvideCustomImageUpdateService(containerTagClient, containerUpdater, serviceBuildInfo, configConfig)
	customImageUpdateHandler := handler.ProvideCustomImageUpdateHandler(customImageUpdateService, systemOperationLockService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, customImageUpdateHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService)
